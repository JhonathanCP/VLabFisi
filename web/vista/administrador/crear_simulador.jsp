        ...
        <div id="right-panel" class="right-panel">
                            ...
                            <div class="page-header float-right">
                                <div class="page-title">
                                    <ol class="breadcrumb text-right">
                                        ...
                                        <li class="active">Crear simulador</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
            ...
            <div class="content">
                <div class="animated fadeIn">
                    <form action="/ProyectoPatrones/controlador_crear_simulador" method="post">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header"><strong>Datos generales</strong><small> </small></div>
                                    <div class="card-body card-block">
                                        <div class="form-group"><label for="name" class=" form-control-label">Nombre</label><input type="text" id="name" name="name" placeholder="Ingrese nombre" class="form-control" required></div>                                        
                                        <div class="form-group"><label for="html" class=" form-control-label">Html Code</label><input type="text" id="html" name="html" placeholder="Ingrese HTML" class="form-control" required></div>
                                        <div class="form-group"><label for="description" class=" form-control-label">Description</label><input type="text" id="description" name="description" placeholder="Ingrese la descripción del simulador" class="form-control" required></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">                                
                                <div class="card">
                                    <div class="card-header"><strong>Curso/Activo</strong></div>
                                    <div class="card-body card-block">                                          
                                        <div class="form-group">
                                            <label for="course" class=" form-control-label">Curso</label>
                                            <select name="course" id="course" class="form-control-sm form-control" required>
                                        ...
                                        <div class="form-group">
                                            <label for="active" class=" form-control-label">Activo</label>
                                                <select name="active" id="active" class="form-control-sm form-control" required>
                                ...
                                <div class="form-actions form-group right-panel"><button type="submit" class="btn btn-success btn-lg">Crear simulador</button></div>
                            </div>
                        </div>
                    </form>
                </div>
