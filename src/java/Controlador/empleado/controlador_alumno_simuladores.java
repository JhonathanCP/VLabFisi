 ...
 * @author centt
 */
@WebServlet(name = "controlador_alumno_simuladores", urlPatterns = {"/controlador_alumno_simuladores"})
public class controlador_alumno_simuladores extends HttpServlet{
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet controlador_alumno_simuladores</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet controlador_alumno_simuladores at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        rd = request.getRequestDispatcher("/vista/empleado/lista_simuladores.jsp");
