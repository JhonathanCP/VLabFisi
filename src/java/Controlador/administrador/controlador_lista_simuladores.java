 ...
 * @author centt
 */
@WebServlet(name = "controlador_lista_simuladores", urlPatterns = {"/controlador_lista_simuladores"})
public class controlador_lista_simuladores extends HttpServlet{
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet controlador_lista_simuladores</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet controlador_lista_simuladores at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
